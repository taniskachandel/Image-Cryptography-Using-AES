...
def en_fun():
    global x, image_encrypted, key, encrypted_data
    key = b'kdjneb4h398fhdbsnjk3hdj893msl292'
    # print(x)
    ...
    # print(image_input)
    image_input = cv2.imread(x,0)
    image_data = image_input.tobytes()
    ...
    encrypted_array = encrypted_array[:129600]
    encrypted_array = encrypted_array.reshape(360,360)

    encrypted_image = encrypted_array[:360, :360]

    image_encrypted = Image.fromarray(encrypted_image)
    image_encrypted.save('encrypted_image.png')
    ...
    imge = Image.open('encrypted_image.png')
...
def de_fun():
    ...
    # decrypted_array = decrypted_array[:129600]
    # decrypted_array = decrypted_array.reshape(360,360)

    # decrypted_image = decrypted_array[:360, :360]

    # image_decrypted = Image.fromarray(decrypted_image)
    # image_decrypted.save('image_output.jpg')
    # image_output = image_encrypted * key
    # image_output *= 255.0
    with open("image_output.jpg", 'wb') as file:
